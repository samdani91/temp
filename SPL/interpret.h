...
void read_for_block(unordered_multimap<string, string> statements, int lineNum);
    ...
    while (!file.eof())
    {
        ...
        {   
         ...
         << "Starting of for loop" << endl;
            ...
            read_for_block(statements2,lineNum);
            lineNum=currlineNum;
            cout << "In line " << lineNum + 1 << " >> "
...
void read_printf(unordered_multimap<string, string> print, int lineNum)
{
    ...
    {
        cout << "In line " << lineNum + 1 << " >> "
             << "This a print statement and which prints a " << fm_spec[format_specifier] << " type number " << var << " and output is " << traceVar[var] << endl;
    }
    else
    {
        cout << "In line " << lineNum + 1 << " >> "
